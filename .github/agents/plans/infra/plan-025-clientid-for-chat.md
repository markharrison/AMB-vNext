...
Use this code in the chat client macthing ManagedIdentityClientId to the ClientID for the managed identity you created for the app service and
assigned ot the genai services:
